...
#define mailbox_incoming_shut(mail_system, content) mail_box_incoming_shut(mail_system, *content)
#define mailbox_outgoing_open(mail_system, content) mail_box_outgoing_open(mail_system, (void **)content)
#define mailbox_outgoing_shut(mail_system, content) mail_box_outgoing_shut(mail_system, *content)
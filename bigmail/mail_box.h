...
static inline void mail_box_create(int content_sizeof,
                                   mail_box_MailBoxHead **out_mailbox);

static inline void mail_box_incoming_open(mail_box_MailBoxHead *mailbox,
                                          void **out_content);

static inline void mail_box_incoming_shut(mail_box_MailBoxHead *mailbox,
                                          void **content);

static inline void mail_box_outgoing_open(mail_box_MailBoxHead *mailbox,
                                          void **out_content);

static inline void mail_box_outgoing_shut(mail_box_MailBoxHead *mailbox,
                                          void **content);

static inline void mail_box_nth_entry(mail_box_MailBoxHead *mailbox,
                                      int n,
                                      mail_box_MailBoxEntryHead **out_entry);

static inline void mail_box_nth_content(mail_box_MailBoxHead *mailbox,
                                        int n,
                                        void **out_content);
